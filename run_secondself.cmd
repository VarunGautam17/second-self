...
if exist "%~dp0secondself\venv\Scripts\python.exe" (
    set "VENV_PYTHON=%~dp0secondself\venv\Scripts\python.exe"
    set "VENV_STREAMLIT=%~dp0secondself\venv\Scripts\streamlit.exe"
    set "APP_DIR=%~dp0secondself"
